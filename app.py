...
st.markdown(
    ...
    <div style='text-align: center; padding: 20px 0;'>
        <p style='font-size: 1.2em; font-family: "Helvetica Neue", sans-serif; color: #a3a8b8;'>
             Olympics Data Analytics & Prediction Dashboard | Created with by <a href='https://github.com/IamAmbrose' target='_blank' style='color: #4bc0c0; text-decoration: none;'>Ambrose Henry</a>
        </p>
    </div>
    """,
